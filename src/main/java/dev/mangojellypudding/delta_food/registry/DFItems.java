package dev.mangojellypudding.delta_food.registry;

import dev.mangojellypudding.delta_food.content.DDFoodItem;
import dev.mangojellypudding.delta_food.content.DDPlaceableFoodBlockItem;
...
public class DFItems {
    ...
    private static DeferredItem<DDFoodItem> registerFood(String name, FoodProperties food,
                                                         Item returnItem, int useDuration, UseAnim useAnim) {
        return (DeferredItem<DDFoodItem>) ITEMS.register(name, () -> {
    ...
    private static DeferredItem<DDPlaceableFoodBlockItem> registerPlaceableFood(String name, DeferredBlock<Block> block,
                                                                                FoodProperties food, Rarity rarity,
                                                                                Item returnItem, int useDuration, UseAnim useAnim) {
        return (DeferredItem<DDPlaceableFoodBlockItem>) ITEMS.register(name, () -> {
    ...
    private static DeferredItem<Item> registerMusicDisc(String name, RegistryObject<SoundEvent> sound,
                                                        int analogOutput, int durationSeconds) {
        return (DeferredItem<Item>) ITEMS.register(name, () -> new MusicDiscItem(
                analogOutput,
                sound,
